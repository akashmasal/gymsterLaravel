        ...
        <div class="row gx-5">
            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100 rounded" src="{{url('frontend/img/about.jpg')}}"
            ...
            <div class="col-lg-7">
                ...
                <h4 class="text-body mb-4">Diam dolor diam ipsum tempor sit. Clita erat ipsum et lorem stet no labore
                    lorem sit clita duo justo magna dolore</h4>
                <p class="mb-4">Nonumy erat diam duo labore clita. Sit magna ipsum dolor sed ea duo at ut. Tempor sit
                ...
                <div class="rounded bg-dark p-5">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="pills-1">
                            <p class="text-secondary mb-0">Tempor erat elitr at rebum at at clita aliquyam consetetur.
                                Diam dolor diam ipsum et, tempor voluptua sit consetetur sit. Aliquyam diam amet diam et
                                eos sadipscing labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit.
                                Sanctus clita duo justo et tempor consetetur takimata eirmod, dolores takimata
                                consetetur invidunt magna dolores aliquyam dolores dolore. Amet erat amet et magna</p>
                        </div>
        ...
        <div class="row g-5 gb-5">
            <div class="col-lg-4 col-md-6">
                <div class="bg-light rounded text-center p-5">
                    ...
                    <p>Sed amet tempor amet sit kasd sea lorem dolor ipsum elitr dolor amet kasd elitr duo vero amet
                        amet stet</p>
    ...
    <div class="container-fluid p-0 my-5">
        <div class="row g-0">
            <div class="col-lg-6" style="min-height: 500px;">
                <div class="position-relative h-100">
                    <img class="position-absolute w-100 h-100" src="{{url('frontend/img/testimonial.jpg')}}" style="object-fit: cover;">
                </div>
            </div>
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="{{url('frontend/img/testimonial-1.jpg')}}" alt="">
                            <div class="ps-4">
                    ...
                    <div class="testimonial-item">
                        <p class="fs-4 fw-normal text-light mb-4"><i
                            ...
                            et tempor diam tempor erat dolor rebum sit ipsum.</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid rounded-circle" src="{{url('frontend/img/testimonial-2.jpg')}}" alt="">
                            <div class="ps-4">
                                <h5 class="text-uppercase text-light">Client Name</h5>
                                <span class="text-uppercase text-secondary">Profession</span>
                            </div>
            ...
            <div class="col-lg-4">
                <div class="blog-item">
                    ...
                    <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                        ...
                        <a class="h5 text-uppercase text-light" href="">Sed amet tempor amet sit kasd sea lorem
                            </h4></a>
                    </div>
                </div>
            </div>
